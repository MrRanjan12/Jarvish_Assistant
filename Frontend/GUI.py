...
# Custom Clickable Label for Microphone Icon
class ClickableLabel(QLabel):
    ...
    def clicked(self):
        pass  # To be overridden by parent class
...
class ChatSection(QWidget):
    def __init__(self): 
        ...
        main_layout.setContentsMargins(0, 40, 40, 20)  # Reduced bottom margin
        main_layout.setSpacing(10)

        # Horizontal layout for chat and GIF
        ...
        content_layout.addWidget(self.chat_text_edit, stretch=3)  # More space for chat
        ...
        content_layout.addWidget(self.gif_label, stretch=1)  # Less space for GIF
        ...
        self.toggled = True
        self.load_icon(GraphicsDirectoryPath('voice.png'))
        self.icon_label.clicked = self.toggle_icon
    ...
    def addMessage(self, message, color):
        ...
        formatm.setLeftMargin(5)  # Reduced left margin for messages
        format.setForeground(QColor(color))
        cursor.setCharFormat(format)
        cursor.setBlockFormat(formatm)
        cursor.insertText(message + '\n')
        self.chat_text_edit.setTextCursor(cursor)
        self.chat_text_edit.ensureCursorVisible()  # Auto-scroll to bottom
